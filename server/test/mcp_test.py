...
async def main():
    async with streamablehttp_client(**server_params) as (read, write, _):
        async with ClientSession(read, write) as session:
            ...
            prompt, params = _generate_prompt_params("Use my traefik dashboard at traefik.tenawalcott.com to summary all my current HTTP routers with name, rule, entrypoint, SSL/TLS, service, and service url", "", chat_config)
